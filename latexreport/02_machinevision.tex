...
The threshold value for edge detection and the circle confidence value are provided by the main program (typically 50 and 30 respectively, though these values can be tweaked further). The minimum and maximum radius are set to 150 and 180 pixels to ensure that only the defined target is detected.
