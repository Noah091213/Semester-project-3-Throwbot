...
The developed system is subject to constraints originating from the physical hardware and from assumptions introduced during modelling and implementation.

The robot motion is limited by the joint limits and Cartesian workspace boundaries defined by the UR5 safety configuration. Only motions that remain within these limits can be executed. The mechanical design of the gripper constrains the admissible release pose and orientation of the ball.
