...
- Control a UR5 and gripper based on modelled trajectory
The solution is expected to consistently hit within the visual bullseye of the Velcro dart board, as seen in figure 1. Specifically, the center of the ball should be within 2 cm of the center of the bullseye. This accuracy would also allow the solution to hit within the opening of a standard American 16 oz red solo cup with a ping pong ball. The accuracy is accepted to be consistent, if at least 90% of throws hit within the accepted target area.
