...
Testing the system and its components can be done in many ways. Because so many parameters can be tweaked, it was important to test many of them to determine their individual effects in the system as a whole. Initial testing was done using simulated throws, by running the trajectory planner, including the ball ballistics and robot path planning, with a range of release point and targets. The results from all tests will be discussed in chapter \ref{chap:discussion}.
