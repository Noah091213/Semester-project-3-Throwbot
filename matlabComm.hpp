...
std::vector<double> createDataToSend(std::vector<double> releasePos, double yaw, double pitch, double releaseVel, double leadTime, double frequency, std::vector<std::vector<double>> transformW2R);
